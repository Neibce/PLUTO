...
init python:
    ...
    #config.keymap['quit'].append('K_AC_BACK')

    style.default.font = "NanumSquareR.ttf"

    ## 볼드체 커스텀
    config.font_replacement_map["NanumSquareR.ttf", True, False] = ("NanumSquareB.ttf", False, False)
    #config.font_replacement_map["VL-PGothic-Regular.ttf", True, False] = ("VL-PGothic-Regular.ttf", False, False)

    style.window.background = Frame("gui/frame.png", 12, 12)

#translate english style default:
#   font "Roboto-Regular.ttf"
#translate japanese style default:
#   font "VL-PGothic-Regular.ttf"
...
define gui.idle_color = '#888888' #aaaaaa
...
define gui.text_font = "NanumSquareR.ttf"

## The font used for character names.
define gui.name_text_font = "NanumSquareR.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "NanumSquareR.ttf"
...
define config.game_menu_action = Show("esc_menu", Dissolve(.3))
...
## bottom order.
define gui.namebox_borders = Borders(9, 5, 49, 10)
...
define gui.confirm_button_borders = Borders(0, 0, 0, 0)
...
define gui.notify_frame_borders = Borders(12, 12, 12, 12)
...
init python:
    ...
    if renpy.variant("touch"):
        ...
        gui.confirm_button_borders = Borders(5, 5, 5, 5)
